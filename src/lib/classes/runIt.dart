...
class runIt {
  ...
  void initVehicle() {
    ...
    u.garage.vehicles[1].manual.createNotification(m11);
    u.garage.vehicles[1].manual.createNotification(m12);
